...
from steakhouse.fov.robot.policy.old.full_state.features_flat import extract_full_flat, OBS_DIM_FULL
from steakhouse.fov.robot.policy.old.full_state.features_grid import (
