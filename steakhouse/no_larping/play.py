...
exactly stationary, which is asserted in test_subtask_dist.py.
...
class App:
        ...
        while True:
            for e in pygame.event.get():
                ...
                if e.type != pygame.KEYDOWN:
                    continue
                if e.key == pygame.K_ESCAPE:      # not q -- q picks the qmdp partner
                    pygame.quit()
                    sys.exit(0)
                if e.key == pygame.K_h:
                    cfg["seat"] = "human"
    ...
    def _footer(self, ep, show_mate):
        ...
        if post:
            ...
            out.append(("%s is theta-blind by construction -- the qmdp-* methods "
