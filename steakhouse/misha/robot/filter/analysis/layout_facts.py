...
Mirrors no_larping/robot/filter/analysis/layout_facts.py. Self-contained: reads
this package's own layout/layouts and its own harness for LAYOUTS.
...
def facts(layout):
    ...
    # evaluate.py's human_index=1 default.
