"""
Bayesian NN — Predict INTENT (12-way) from obs sequences.
...
Run:
  /Users/mishafu/miniconda3/envs/steakhouse-ai/bin/python bnn_intent.py
"""
...
NUM_INTENTS = len(IDX_TO_INTENT) #should be 12
...
def create_sequences_intent(df: pd.DataFrame, L: int):
    ...
    y: the intent at the window’s last timestep (index t)
...
def main():
    ...
    model  = BNN(seq_len=L, input_dim=input_dim, hidden_dim=CFG["hidden_dim"], output_dim=NUM_INTENTS).to(device)
