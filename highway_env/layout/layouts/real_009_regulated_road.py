"""EXPERIMENT, not a validated layout: real_009_rebuilt's own network,
...
why this lives in a separate file rather than editing real_009_rebuilt.py
...
from real_009_rebuilt import (  # noqa: F401 -- re-exposed for any tooling that expects these names
