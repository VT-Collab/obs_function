"""EXPERIMENT, not a validated layout: real_006_rebuilt's own network,
...
why this lives in a separate file rather than editing real_006_rebuilt.py
...
from real_006_rebuilt import (  # noqa: F401 -- re-exposed for any tooling that expects these names
