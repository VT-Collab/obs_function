...
def _build_network() -> RoadNetwork:
    ...
    bridge_roundabout(net, "ra_", _RA_IN_K, "tw1_", 1, j_lane_i=1)

    # Quarter-turn around the ring -> TW2's south arm (stem).
    ...
    # RIGHT turn onto the east arm -> highway merge.
    tw2_far, tw2_heading = exit_far(net, "tw2_", 3, 0)
    ...
    bridge(net, "tw2_o3_0", "mg_a_0", tw2_far, mg_center)
...
_SHARED_TAIL = [
    ...
    ("tw2_o0_0", "tw2_ir0_0", 0), ("tw2_ir0_0", "tw2_il3_0", 0),  # right turn onto the east arm
    ("tw2_il3_0", "tw2_o3_0", 0), ("tw2_o3_0", "mg_a_0", 0),
