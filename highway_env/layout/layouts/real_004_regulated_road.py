"""EXPERIMENT, not a validated layout: real_004_rebuilt's own network,
...
why this lives in a separate file rather than editing real_004_rebuilt.py
...
from real_004_rebuilt import (  # noqa: F401 -- re-exposed for any tooling that expects these names
