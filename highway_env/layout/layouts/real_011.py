"""Real scene 011: real Waymo-derived road network (nocturne), plus the
...
Source: tfrecord-00569-of-01000_314.json, objects[1]/objects[9].
See _real_scene.py for how the import works.
"""
from _real_scene import build_road_from, trajectories_from

SCENE_PATH = "/Users/mishafu/Desktop/obs_function/nocturne/data/formatted_json_v2_no_tl_train/tfrecord-00569-of-01000_314.json"
HUMAN_VEHICLE_IDX, ROBOT_VEHICLE_IDX = 1, 9
