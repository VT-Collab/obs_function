"""Real scene 025: real Waymo-derived road network (nocturne), plus the
...
Source: tfrecord-00302-of-01000_249.json, objects[1]/objects[2].
See _real_scene.py for how the import works.
"""
from _real_scene import build_road_from, trajectories_from

SCENE_PATH = "/Users/mishafu/Desktop/obs_function/nocturne/data/formatted_json_v2_no_tl_train/tfrecord-00302-of-01000_249.json"
HUMAN_VEHICLE_IDX, ROBOT_VEHICLE_IDX = 1, 2
