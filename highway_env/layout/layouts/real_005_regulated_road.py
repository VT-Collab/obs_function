"""EXPERIMENT, not a validated layout: real_005_rebuilt's own network,
...
why this lives in a separate file rather than editing real_005_rebuilt.py
...
from real_005_rebuilt import (  # noqa: F401 -- re-exposed for any tooling that expects these names
