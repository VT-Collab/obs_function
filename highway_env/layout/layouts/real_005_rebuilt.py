...
def _build_network() -> RoadNetwork:
    ...
    # Quarter-turn around the ring -> second T-junction, entering its
    ...
    stitch_junction(net, ("roundabout", "ra_", _RA_OUT_K, 0), "tw_", TW2_ACCESS, N_TW2,
                     missing_corner=TW2_MISSING_CORNER, gap=GAP)

    # LEFT turn onto the west arm -> highway merge, bidirectional (matching
    # every other primitive here) and exact_center=True since this bridges
    # N_TW2 lanes in parallel.
    stitch_merge(net, ("junction", "tw_", 1, 1), "mg_", MG_LANES, gap=GAP, exact_center=True,
...
_SHARED_TAIL = [
    ...
    (f"ra_farout{_RA_OUT_K}_1", "tw_o0_1", 0),
    ("tw_o0_1", "tw_ir0_1", 0), ("tw_ir0_1", "tw_il1_1", 0),  # left turn onto the west arm, lane 1
    ("tw_il1_1", "tw_o1_1", 0), ("tw_o1_1", "mg_a_1", 0),     # bridge, into the highway's own normal lane 1
