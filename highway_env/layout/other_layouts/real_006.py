"""Real scene 006: real Waymo-derived road network (nocturne), plus the
...
Source: tfrecord-00949-of-01000_322.json, objects[8]/objects[13].
See _real_scene.py for how the import works.
"""
from _real_scene import build_road_from, trajectories_from

SCENE_PATH = "/Users/mishafu/Desktop/obs_function/nocturne/data/formatted_json_v2_no_tl_train/tfrecord-00949-of-01000_322.json"
HUMAN_VEHICLE_IDX, ROBOT_VEHICLE_IDX = 8, 13
