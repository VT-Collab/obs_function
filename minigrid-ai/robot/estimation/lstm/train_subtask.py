#!/usr/bin/env python3
"""
Train LSTM to predict the NEXT subtask from flattened MiniGrid CSV.
...
from robot.estimation.lstm.dataset import flatten_record, flatten_episode, expected_dim
from robot.estimation.lstm.model import LSTMModel
...
def main():
    ...
    model  = LSTMModel(seq_len=L, input_dim=input_dim, hidden_dim=CFG["hidden_dim"], output_dim=NUM_CLASSES).to(device)
